...
// Package timeutil parses date-strings without knowing the format
...
// MustParse  parse a date, and zero time.Time{} returned if it can't be parsed.  Used for testing.
