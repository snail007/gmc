...
func TestRouterAPI(t *testing.T) {
	...
	router := New()
	router.GET("/GET", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		get = true
	})
	router.HEAD("/GET", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		head = true
	})
	router.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		options = true
	})
	router.POST("/POST", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		post = true
	})
	router.PUT("/PUT", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		put = true
	})
	router.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		patch = true
	})
	router.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		delete = true
	})
...
func TestRouterInvalidInput(t *testing.T) {
	...
	handle := func(_ http.ResponseWriter, _ *http.Request, _ gcore.Params) {}
...
func TestRouterChaining(t *testing.T) {
	...
	fooHit := false
	router1.POST("/foo", func(w http.ResponseWriter, req *http.Request, _ gcore.Params) {
		fooHit = true
		w.WriteHeader(http.StatusOK)
	})

	barHit := false
	router2.POST("/bar", func(w http.ResponseWriter, req *http.Request, _ gcore.Params) {
		barHit = true
		w.WriteHeader(http.StatusOK)
	})
...
func BenchmarkAllowed(b *testing.B) {
	handlerFunc := func(_ http.ResponseWriter, _ *http.Request, _ gcore.Params) {}
...
func TestRouterOPTIONS(t *testing.T) {
	...
	// custom handler
	var custom bool
	router.OPTIONS("/path", func(w http.ResponseWriter, r *http.Request, _ gcore.Params) {
		custom = true
	})
...
func TestRouterPanicHandler(t *testing.T) {
	...
	router.Handle(http.MethodPut, "/user/:name", func(_ http.ResponseWriter, _ *http.Request, _ gcore.Params) {
		panic("oops!")
	})
...
func TestRouterMatchedRoutePath(t *testing.T) {
	route1 := "/user/:name"
	routed1 := false
	handle1 := func(_ http.ResponseWriter, req *http.Request, ps gcore.Params) {
	...
	routed2 := false
	handle2 := func(_ http.ResponseWriter, req *http.Request, ps gcore.Params) {
		route := ps.MatchedRoutePath()
		if route != route2 {
	...
	route3 := "/"
	routed3 := false
	handle3 := func(_ http.ResponseWriter, req *http.Request, ps gcore.Params) {
		route := ps.MatchedRoutePath()
		if route != route3 {
