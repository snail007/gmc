...
func (s *GMCLog) SetLevel(i gmccore.LOG_LEVEL) {
	s.level = i
}

func (s *GMCLog) With(namespace string) gmccore.Logger {
	return &GMCLog{
		l:      s.l,
		parent: s,
		ns:     namespace,
